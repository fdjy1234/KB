...
- [k8s-architecture-layered-guide.md](k8s/k8s-architecture-layered-guide.md)：企業級 Kubernetes 分層架構選型指南，涵蓋安全、治理與保險業合規情境。

## Other

- [Insurance_MIS_CareerLevelFramework.md](other/Insurance_MIS_CareerLevelFramework.md)：產險業 MIS 職能分級框架，定義開發與分析雙軌能力模型。
